...
PitchClass {
	...
	*new {arg pitch, octave = 4, alter = 0;
	...
	getInterval {arg aPC2;
		...
		if((this.class.asString!="PC".asString)|| (aPC2.class.asString!="PC".asString)){
	...
	*/
	...
	get_three_part_voicings {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
	...
	get_three_part_voicingsPC {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
		var temp_val, outlist ,
		voicing_table_first_last = [
			[2,2],[2,5], [2,7], [2,9],
			[3, 4],
		...
		*/
		...
		{voice == 0}{
			outlist = [this, this.finalModalTranspose(pc.filterKeynum(this.keynum), pc, temp_val[0].neg)[4],
				this.finalModalTranspose(pc.filterKeynum(this.keynum), pc, temp_val.sum.neg)[4]].postcs;
		}
		{voice == 1}{
			outlist = [this, this.finalModalTranspose(pc.filterKeynum(this.keynum), pc, temp_val[0])[4],
				this.finalModalTranspose(pc.filterKeynum(this.keynum), pc, temp_val[1].neg)[4]].postcs;
		}
		{voice == 2}{
			outlist = [this, this.finalModalTranspose(pc.filterKeynum(this.keynum), pc, temp_val[0])[4],
				this.finalModalTranspose(pc.filterKeynum(this.keynum), pc, temp_val.sum)[4]].postcs;
		};

		^outlist;
	}

	get_two_part_voicingsPC_and_Keynum {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
	...
	get_three_part_voicingsPC_and_Keynum {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
		var temp_val, outlist, keynumlist,
		voicing_table_first_last = [
			[2,2],[2,5], [2,7], [2,9],
			[3, 4],
	...
	*/
	...
	get_two_part_voicingsPC_and_KeynumTable {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
	...
	get_three_part_voicingsPC_and_KeynumTable {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
	...
	get_four_part_voicingsPC_and_Keynum {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
		var temp_val, outlist, keynumlist,
		voicing_table_first_last = [
	...
	*/
	...
	get_four_part_voicingsPC_and_KeynumTable {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
	...
	get_five_part_voicingsPC_and_Keynum {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
	...
	get_five_part_voicingsPC_and_KeynumTable {arg voice = 0, firstlast_or_middle = 0, pc = PColl.lydian(\a);
		var temp_val, outlist = LinkedList.new, keynumlist = LinkedList.new,
		voicing_table_first_last = [
	...
	*/
	...
	finalModalTranspose {arg aPC, toAPitchCollection, steps;
		...
		^[toAPitchCollection.degrees, steparr, scale_degree, degree_steps_to_half_steps, PC(degree_steps_to_half_steps+aPC.keynum)];
	}
	...
	mtrans1 {arg aPC, toAPitchCollection, scale, steps;
		...
		if(steps.isNegative){
			...
			outnote2 = PC(aPC.keynum-outnote);
	...
	[PC(64).distanceFrom2(PC(95-70+i)),i].postln}

	PC(64).distanceFrom2(PC(76))
